...
rest_habits <- rest_habits %>%
  mutate(category = case_when(
     ...
     undergrad %in% c("Marketing", "Accounting", "Finance", "International Business", "Advertising and Public Relations", "General Business", "Management", "Hospitality and Tourism Management", "Human Resource Management", "Communication Studies", "Criminal Justice", "Legal Studies") ~ "busLeg",
     grad == "" ~ "cultHum", #Cultures and Humanities
     undergrad %in% c("French", "Spanish", "History", "English", "Writing") ~ "cultHum",
     grad == "" ~ "science", #Biological, Environmental, and Physical Sciences
     undergrad %in% c("Biology"),  ~ "science",
     grad %in% c("Education", "Higher Education", "School Psychology") ~ "education", #Education
     undergrad %in% c("Education", "Higher Education", "School Psychology", "Art Education") ~ "education",
     ...
     undergrad %in% c("Physician Assistant Studies", "Medical Dosimetry", "Public Health", "Physical Therapy", "Nursing") ~ "health",
     grad %in% c("Biostatistics", "Data Science and Analytics") ~ "mathEng", #Math and Engineering
     undergrad %in% c("Biostatistics", "Data Science and Analytics") ~ "mathEng",
     grad %in% c("Speech-Language Pathology", "Social Work") ~ "socBehave", #Social and Behavioral Sciences
     undergrad %in% c("Speech-Language Pathology", "Social Work") ~ "socBehave",
     )
  )
```
