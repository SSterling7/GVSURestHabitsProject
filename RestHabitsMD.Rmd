...
gradCat %>%
  mutate(category = case_when(
     grad %in% c("Communications", "Business Administration") ~ "busLeg", #Business & Legal
     grad == "" ~ "cultHum", #Cultures and Humanities
     grad == "" ~ "science", #Biological, Environmental, and Physical Sciences
     grad %in% c("Education", "Higher Education") ~ "education", #Education
     grad == "" ~ "art", #Fine Arts and Design
     grad %in% c("Physician Assistant Studies", "Medical Dosimetry", "Public Health", "Physical Therapy") ~ "health", #Health and Medicine
